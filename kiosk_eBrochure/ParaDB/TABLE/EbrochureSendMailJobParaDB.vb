...
Namespace TABLE
    'Represents a transaction for eBROCHURE_SEND_MAIL_JOB table Parameter.
    '[Create by  on October, 31 2014]

    <Table(Name:="eBROCHURE_SEND_MAIL_JOB")>  _
    Public Class EbrochureSendMailJobParaDB
        ...
        Public Property CUSTOMER_EMAIL() As String
            ...
            End Set
        End Property 
        <Column(Storage:="_IS_SEND_MAIL", DbType:="Char(1) NOT NULL ",CanBeNull:=false)>  _
        Public Property IS_SEND_MAIL() As Char
            Get
