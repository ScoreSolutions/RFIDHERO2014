...
Namespace TABLE
    ...
    Public Class ErmTsPersonalInfoLinq
        ...
        Dim _ERM_TS_INTEREST_erm_ts_personal_info_id As DataTable

        Public Property CHILD_ERM_TS_INTEREST_erm_ts_personal_info_id() As DataTable
            Get
                'Child Table Name : ERM_TS_INTEREST Column :erm_ts_personal_info_id
                Dim trans As New Linq.Common.Utilities.TransactionDB
                Dim ErmTsInterestItem As New ErmTsInterestLinq
                _ERM_TS_INTEREST_erm_ts_personal_info_id = ErmTsInterestItem.GetDataList("erm_ts_personal_info_id = " & _ID, "", trans.Trans)
                trans.CommitTransaction()
                ErmTsInterestItem = Nothing
                Return _ERM_TS_INTEREST_erm_ts_personal_info_id
            End Get
            Set(ByVal value As DataTable)
                _ERM_TS_INTEREST_erm_ts_personal_info_id = value
            End Set
        End Property
    End Class
End Namespace
