...
{
    if (FSDKE_OK != FSDK_ActivateLibrary("MDT+qnvcLrZn+3LL6fRZJ/tFjPRk7LR90chU4O8lpR1L0Blmcnu7NKdEwgkDZ5T9BylWzBmu1uuy5sIFJb1w0kPlZdKTNrWLFblWrh++bxp039ehq0yjg9hz4JyJ9693iqiTdgkvVba3B6+c6gXDjoyTrIDGRUz4WafWxQpyT4A=")) {
...
#ifndef _WIN64 
	SendMessage(hwnd, LB_ADDSTRING, 0, (long)(L"Press Enter to open image, press Esc to exit ...")); 
#endif
